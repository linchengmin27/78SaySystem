...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->  
  <head>
	...
	function ajaxSearch(page) {
		var url = basePath + '/records/detail/${entity.id}/' + page + '.html';
  	...
  	<div class="breadcrumbs margin-bottom-40">
		<div class="container">
	        ...
	        <ul class="pull-right breadcrumb">
	            ...
	            <li><a href="${ctx}/records/index.html">吉尼斯纪录</a> <span class="divider">/</span></li>
	    	...
	    	<div class="span3">
	        	<div class="posts">
	                ...
	                <dl class="dl-horizontal">
	                    <dt><a href="${ctx}/records/detail/${article.id}.html"><img src="${ctx}/${article.logo}" alt="" /></a></dt>
	                    <dd>
	                        <p><a href="${ctx}/records/detail/${article.id}.html">${article.title}</a></p> 
	                    </dd>
	                </dl>
	                </c:forEach>
                </div>
