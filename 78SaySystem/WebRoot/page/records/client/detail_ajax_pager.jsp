...
<div class="pagination pagination-centered">
    <ul>
        <c:choose>
    		...
    		<li><a href="${ctx}/records/detail/${entity.id}/${chapterPageBean.currentPage - 1 }.html">上一页</a></li>
    		</c:when>
    		<c:otherwise>
      	...
      	<c:forEach items="${chapterPageBean.getShowPage()}" var="sp" varStatus="stat">
      		<c:choose>
      			...
      			<c:otherwise>
      			<li><a href="${ctx}/records/detail/${entity.id}/${sp}.html">${sp}</a></li>
      			</c:otherwise>
      		</c:choose>
      	</c:forEach>
        ...
        <c:choose>
          	...
          	<li><a href="${ctx}/records/detail/${entity.id}/${chapterPageBean.currentPage + 1}.html">下一页</a></li>
          	</c:when>
          	<c:otherwise>
