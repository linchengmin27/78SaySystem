...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->  
  <head>
	...
	function ajaxSearch(page) {
		var url = basePath + '/world/detail/${entity.id}/' + page + '.html';
	    	...
	    	<div class="span3">
	        	<div class="posts">
	                ...
	                <dl class="dl-horizontal">
	                    <dt><a href="${ctx}/world/detail/${article.id}.html"><img src="${ctx}/${article.logo}" alt="" /></a></dt>
	                    <dd>
	                        <p><a href="${ctx}/world/detail/${article.id}.html">${article.title}</a></p> 
	                    </dd>
	                </dl>
	                </c:forEach>
                </div>
